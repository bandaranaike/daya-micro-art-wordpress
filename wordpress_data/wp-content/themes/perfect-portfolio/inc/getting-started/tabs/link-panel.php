...
<div class="panel-right">
	...
	<div class="panel-aside">
		...
		<a class="button button-primary" href="<?php echo esc_url( 'https://docs.rarathemes.com/docs/' . PERFECT_PORTFOLIO_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the knowledge base', 'perfect-portfolio' ); ?>" target="_blank"><?php esc_html_e( 'Visit the Knowledge Base', 'perfect-portfolio' ); ?></a>
