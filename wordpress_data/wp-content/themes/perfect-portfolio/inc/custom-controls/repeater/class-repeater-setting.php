<?php
/**
 * Perfect Portfolio Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Perfect_Portfolio_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Perfect_Portfolio_Repeater_Setting extends WP_Customize_Setting {
