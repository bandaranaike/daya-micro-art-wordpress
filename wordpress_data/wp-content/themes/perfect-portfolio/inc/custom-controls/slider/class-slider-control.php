<?php
/**
 * Perfect Portfolio Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Perfect_Portfolio_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Perfect_Portfolio_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'perfect-portfolio-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'perfect-portfolio-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
