...
if( ! function_exists( 'perfect_portfolio_load_preload_local_fonts') ) :
/**
 ...
 */
function perfect_portfolio_load_preload_local_fonts( $url, $format = 'woff2' ) {
...
if( ! function_exists( 'perfect_portfolio_flush_local_google_fonts' ) ){
	/**
	 * Ajax Callback for flushing the local font
	 */
  	function perfect_portfolio_flush_local_google_fonts() {
		$WebFontLoader = new Perfect_Portfolio_WebFont_Loader();
		//deleting the fonts folder using ajax
		$WebFontLoader->delete_fonts_folder();
		die();
  	}
}
add_action( 'wp_ajax_flush_local_google_fonts', 'perfect_portfolio_flush_local_google_fonts' );
add_action( 'wp_ajax_nopriv_flush_local_google_fonts', 'perfect_portfolio_flush_local_google_fonts' );
