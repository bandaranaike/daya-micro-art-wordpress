...
/**
 * Class formula_Customize_Radio_Buttonset_Control
 */
class formula_Customize_Radio_Buttonset_Control extends formula_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'formula-radio-buttonset';
